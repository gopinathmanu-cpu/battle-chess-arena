...
if (releasePropertiesFile.exists()) {
    ...
    throw GradleException("android/key.properties is required for a release build")
}

android {
    namespace = "com.manugopinath.battlechessarena"
    ...
    defaultConfig {
        ...
        applicationId = "com.manugopinath.battlechessarena"
